...
import com.example.kisilerapp.databinding.FragmentFamilyBinding
...
class FamilyFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        binding.familypageRecyclerview.layoutManager = LinearLayoutManager(context)
        adapter = PersonAdapter()
        binding.familypageRecyclerview.adapter = adapter

        GlobalScope.launch {
            launch(Dispatchers.IO) {
                val status = db.getPersonsDao().getGroupPersons("Family")
